...
echo "==> airgrab npm update publish"
...
read -r -p "New version to publish: " NEW_VERSION
...
echo ""
echo "This will publish an update:"
...
read -r -p "Continue with version bump and npm publish? [y/N]: " CONFIRM
case "$CONFIRM" in
  y|Y|yes|YES) ;;
  *)
    echo "Cancelled."
